@pls_grace @platform @sanity @1.5release

Feature: Admin Settings Customers section - Access Request-Removed

  Scenario: Validate the section Headers in the Customer 360 of a customer whose request is in Removed State
 ...
 Scenario: Validate whether the tabs AccessSummary and Request History are displayed 
  ...
  Scenario: Validate the contnet displayed within What data will be shared with me? section in customer 360 of a Customer whose Request is in Removed State
 ...
 Scenario: Validate the Access status displayed for the partner Users in customer 360 of a Customer whose Request is in Removed State
  When In Customer 360, Validate the Access status displayed for the Users in the Partner Users table, where Org access is Removed
